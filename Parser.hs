...
happyExpList = Happy_Data_Array.listArray (0,67) ([0,5120,0,16384,1,0,1024,0,512,32768,0,0,0,0,0,1024,0,320,0,6144,0,32768,1,0,0,496,8192,0,16384,0,0,0,0,0,496,0,0,0,0,32768,1,0,24,0,384,0,6144,0,32768,1,0,0,0,384,0,0,0,0,0,0,0,0,0,7168,0,49152,1,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseTokens","Prog","Stmt","Expr","Args","'='","'+'","'-'","'*'","'/'","'%'","'<'","'>'","':='","'<='","'>='","'=='","'&&'","'||'","fn","if","else","for","return","print","int","ident","'('","')'","'{'","'}'","','","';'","%eof"]
        bit_start = st * 36
        bit_end = (st + 1) * 36
...
action_11 (34) = happyShift action_23
...
action_15 (9) = happyShift action_17
...
action_18 (6) = happyGoto action_28
